...
class BTDevice:
    ...
    def init_bluez_profile(self):
        ...
        profile = BluetoothBluezProfile(bus, self.config["PROFILE_DBUS_PATH"])
    ...
    def listen(self):
        ...
        self.scontrol.bind((self.config["MAC_ADDRESS"], self.P_CTRL))
        self.sinterrupt.bind((self.config["MAC_ADDRESS"], self.P_INTR))
        print("listen...")
